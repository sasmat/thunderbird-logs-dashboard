...
export default function EditSubmission({ submission, contacts }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        interest_rate: submission.interest_rate?.toString() || '',
        borrower_total_valuation: submission.borrower_total_valuation?.toString() || '',
        thunderbird_total_valuation: submission.thunderbird_total_valuation?.toString() || '',
        loan_amount: submission.loan_amount || '',
        balloon_payment: submission.balloon_payment || '',
        monthly_payment: submission.monthly_payment || '',
        is_business_state_valid: submission.is_business_state_valid || 'none',
        case_status: submission.case_status || '',
        itp_fee: submission.itp_fee?.toString() || '',
    });
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">
                            Update submission information and settings
                        </p>
                    </div>
                </div>
                ...
                <Card className="max-w-4xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update the submission details. All fields are optional except contact selection.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
